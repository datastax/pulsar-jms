 ...
 *
 * <p>This class can be used to split composite URI's into their component parts and is used to
...
public class URISupport {
   ...
   *
   * <p>This method differs from the parseQuery method in that it handles composite URI types and
  ...
  public static URI applyParameters(
      URI uri, Map<String, String> queryParameters, String optionPrefix) throws URISyntaxException {
   ...
   *
   * <p>When the query options of a URI are applied to certain objects the used portion of the query
