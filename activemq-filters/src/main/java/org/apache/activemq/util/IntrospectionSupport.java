...
public final class IntrospectionSupport {
  ...
  private static Object convert(Object value, Class to) {
    ...
    // special for String to List<ActiveMQDestination> as we do not want to use a PropertyEditor for
    // that
  ...
  public static String toString(
      Object target, Class stopClass, Map<String, Object> overrideFields) {
  ...
  private static void addFields(
      Object target, Class startClass, Class<Object> stopClass, LinkedHashMap<String, Object> map) {
