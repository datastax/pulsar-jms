 ...
 *
 * <p>For Example: REPLACE('1,2/3', '[,/]', ';') returns '1;2;3'
 */
public class replaceFunction implements FilterFunction {
  ...
  public boolean isValid(FunctionCallExpression expr) {
    if (expr.getNumArguments() == 3) return true;
  ...
  /**
   * Evaluate the given expression for this function in the given context. The result of the
   * evaluation is a string with all matches of the regular expression, from the evaluation of the
   * second argument, replaced by the string result from the evaluation of the third argument.
   * Replacement is performed by String#replaceAll().
   *
   * <p>Note that all three arguments must be Strings.
   *
   * @param expr - the expression consisting of a call to this function.
