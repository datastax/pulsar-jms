...
public class makeListFunction implements FilterFunction {
  /**
   * Check whether the given expression is a valid call of this function. Any number of arguments is
   * accepted.
   *
   ...
   * given. Creates a list containing the evaluated results of its argument expressions.
   *
   * @param expr - the expression consisting of a call to this function.
